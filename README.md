...
Скачайте мобильное приложение Vkatun (APK-файл) из репозитория и установите его на Android-смартфон. После установки запустите приложение — оно готово к использованию.
...
|                     | Логин            | Пароль |
|---------------------|------------------|--------|
| Администратор       | admin@mail.ru    | admin11! |
| Обычный пользователь | test@example.com | testuser1! |
### Тестовые резюме
